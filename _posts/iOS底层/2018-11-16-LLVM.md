...
4. 安装完毕后的路径图
    ...
    ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/llvm07.png)
...
2. 设置插件的必要文件
    1. 在【zh-plugin】目录下
        ...
        3. 目录如下：
            ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/llvm08.png) 
3. 编写插件源码
    ...
    3. 打开Xcode模板
        ...
        7. 如下图：
            ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/llvm09.png) 
4. 加载插件
    1. 在Xcode项目中指定加载插件动态库:BuildSettings > OTHER_CFLAGS
        1. -Xclang -load -Xclang 动态库路径 -Xclang -add-plugin -Xclang 插件名称      
        
        ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/llvm10.png) 
    2. 然后编译Xcode会发现报错
