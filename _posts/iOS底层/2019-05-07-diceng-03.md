...
5. Person对象调用addObserver之后如下：
    ...
    ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/diceng08.png)
...
2. 经过上面的代码分析，KVC的原理如下图
    1. setValue:forKey:的原理 
        ...
        5. 调用setValue:forUndefinedKey:，并抛出异常NSUnknownKeyException
            ...
            ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/diceng09.png)
    ...
    2. valueForKey:的原理 
        ...
        4. 调用valueForUndefinedKey:，并抛出异常NSUnknownKeyException
            ...
            ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/diceng10.png)
