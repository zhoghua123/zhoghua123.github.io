...
3. 如何在网页中快速筛查当前页面哪些地方用了某种特殊HTML元素？ 
    1. 进入代码检查，切换进Elements模块
    2. 右边小窗口，选择Styles（点击左边Elements中的任意一个元素，右边Styles显示改元素设置的所有css属性），点击小窗口右上角的“+”
    3. 比如：筛查当前网页的所有div元素，则添加一个div特有样式：

        ![pic](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/webzh_06.png) 
...
3. 举例：
    ...
    1. 效果
        ![pic](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/webzh_03.png) 
...
3. 字符实体名称与编号都是**固定**的，如下图
    ...
    ![pic](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/webzh_04.png) 
4. 代码示例：
