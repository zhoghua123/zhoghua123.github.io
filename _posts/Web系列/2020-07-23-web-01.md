...
1. 标准流特点
    1. 块级标签（block）
        1. 元素独占一行，可以设置size，height默认包裹内容即使整行有空间，也不允许其他元素侵占
    2. 行内标签（inline）
        1. 非替换元素
...
![pic](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/webzh_41.png)

#### 网页定位分析
![pic](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/webzh_42.png)
