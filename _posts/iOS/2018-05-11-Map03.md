...
3. 迷惑点
    ...
    4. 以下两个图要理解
        1. 这2部分是一个大头针视图
            ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/dtz1.png)  
        2. 这2部分是两个大头针视图
            ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/dtz2.png) 
4. 代码分析: 
    1. 理解下面各个类的作用:
