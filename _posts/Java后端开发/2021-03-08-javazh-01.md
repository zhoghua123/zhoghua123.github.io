...
2. 开发环境配置   
    ...
    2. 安装Tomcat（windows）
        1. 下载地址：[https://tomcat.apache.org](https://tomcat.apache.org)
            ...
            2. 可以看到
                1. Binary Distributions是二进制，就是安装包，选择zip
                2. Source Code Distributions 源代码，选择zip
        ...
        6. 启动和关闭Tomcat(TOMCAT_HOME指的是Tomcat的安装目录)
            ...
            3. Tomcat启动成功的前提条件：配置好JAVA_HOME
                ...
                2. startup.bat本质是是调用catalina.bat，catalina.bat的本质里面用到了JAVA_HOME，回去查找JVM的安装目录
...
5. 点击完成
6. 也需要配置访问路径(/hello)，用来区分当前项目是服务器软件Tomcat下的哪一个项目。
7. 项目目录
...
2. 添加第一个子模块，可以选择模块为Java Enterprise,项目名为01_HelloWorld,在TestProj文件夹下有个01_HelloWorld文件夹
