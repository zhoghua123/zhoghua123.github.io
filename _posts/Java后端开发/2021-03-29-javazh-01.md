...
5. 代码举例
    ...
    //        dispatcher.forward(request, response);
        ...
        ```
    2. 在webapp文件夹下新建一个login.jsp(要导入标签库，步骤见2、3)
...
![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/javazh-16.png)

### 转发（forward）
1. 在同一个Context(项目)中进行请求转发
2. 一个请求只能在同一个项目的Servlet之间转发

![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/javazh-17.png)
...
3. 代码举例：
    ...
    4. 打断点，可以看到下面的转发链条
        ...
        ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/javazh-18.png)
        
### 重定向（redirect)
1. 重定向：服务器通知客户端重新发送请求到新的任意URL地址
    
    ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/javazh-19.png)
