...
1. TCP数据段头及说明
2. 也分为段头+数据部分
    ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/translate22.png)
    1. 端口：每个端口对应一个应用程序 
    2. 序号：发送的字节序号（32位表示）
    ...
    5. 保留：以备扩展之用 
    6. 码位：  
        ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/translate23.png)
        1. URG：  紧急指针有效
        2. ACK：  确认号有效
    ...
    7. 窗口：接收方窗口大小（流量控制）
    8. 校验和：包括报头、数据和伪段头
        ![图1](https://raw.githubusercontent.com/zhoghua123/imgsBed/master/translate24.png)
